<template>
  <div class="container_box">
    <div class="nav">
      ...
      <router-link class="normal" to="/parttime">兼职任务 </router-link>
    ...
    <span class="iconfont icon-bianjixiugai-copy">
      <h6>发布悬赏</h6>
    </span>
    <div class="box">
      <div class="left-area">
          ...
          <div class="scroll_area">
            <ul>
              <li>
                <div class="left">
                  <div class="profile">
                    <span class="iconfont icon-tubiao31"></span>
                  </div>
                  <div class="phone">{{ phone }}</div>
                  <div class="join">
                    <span class="iconfont icon-tubiao331"></span>
                    参加人数：{{ joinpeople }}人
                  </div>
                </div>
                <div class="right">
                  ...
                  <div class="bodynav">
                    ...
                    >
                    <span>工作时间:{{ workTime }}天</span>
                  </div>
                  <div class="text">Views Details&nbsp;&nbsp;-></div>
                  <div class="resign">
                    <span class="iconfont icon-xintubiao-"></span>
                    招聘人数：{{ resignpeople }}
                  </div>
                  <div class="address">
                    <span class="iconfont icon-daohangtubiao"></span>
                    {{ address }}
                  </div>
                </div>
              </li>
...
export default {
  ...
  data() {
    return {
      pictureList: [
        { url: require("@/assets/imgs/paint.webp") },
        { url: require("@/assets/imgs/desk.webp") },
        { url: require("@/assets/imgs/phone.webp") },
        { url: require("@/assets/imgs/computer.webp") },
        { url: require("@/assets/imgs/balency.webp") },
      ],
      phone: "+18608267777",
      joinpeople: "3",
      userName: "半面妆",
      tips: "ui设计",
      views: "109",
      publishTime: "2022-12-13 12:12:12",
      tradeType: "入账",
      wage: "1000",
      ExpectedPrestige: "10",
      ExpectedExperience: "17",
      workTime: 10,
      resignpeople: 20,
      address: "成都",
    };
